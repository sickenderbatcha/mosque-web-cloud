                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input {...field} placeholder="இறந்தவர் பெயர்" className="font-tamil h-12 text-xl leading-normal placeholder:font-tamil placeholder:text-xl placeholder:leading-normal md:h-10 md:text-base md:placeholder:text-base" />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input {...field} placeholder="தந்தை பெயர்" className="font-tamil h-12 text-xl leading-normal placeholder:font-tamil placeholder:text-xl placeholder:leading-normal md:h-10 md:text-base md:placeholder:text-base" />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input {...field} placeholder="திருமணமான பெண்களுக்கு மட்டும்" className="font-tamil h-12 text-xl leading-normal placeholder:font-tamil placeholder:text-xl placeholder:leading-normal md:h-10 md:text-base md:placeholder:text-base" />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}

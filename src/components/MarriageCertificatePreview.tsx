...
export default function MarriageCertificatePreview({ record }: Props) {
  ...
  useEffect(() => {
    ...
    const fetchCertificateNumber = async () => {
      const certNumber = await generateMarriageCertificateNumber();
      console.log("Marriage Certificate Number fetched:", certNumber);
